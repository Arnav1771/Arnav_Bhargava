...
function HomePage(props) {
    ...
    return (
        <HomePageStyled>
            ...
            <div className="underlayText">Arnav Bhargava</div>

            <div className="typography">
                <div className="greeting">
                    <span className="blinker">▌</span>
                    <span className="prefix"> Hi, I&apos;m </span>
                </div>
                <h1>
                ...
                <div className="icons">
                    <a href="https://github.com/Arnav1771" className="icon i-github" target="_blank" rel="noopener noreferrer">
                        <GithubIcon />
                    </a>
                    <a href="https://www.linkedin.com/in/arnav-bhargava-845457280/" className="icon i-linkedin" target="_blank" rel="noopener noreferrer">
                        <LinkedInIcon />
                    </a>
                    <a href="https://www.youtube.com/@arnavplays4468" className="icon i-youtube" target="_blank" rel="noopener noreferrer">
                        <YoutubeIcon />
                    </a>
...
const HomePageStyled = styled.header`
    ...
    .typography {
        ...
        .icons {
            ...
            .i-youtube:hover  { border-color: red; color: red; box-shadow: 0 0 12px rgba(255,0,0,0.3); }
            .i-github:hover   { border-color: #5F4687; color: #5F4687; box-shadow: 0 0 12px rgba(95,70,135,0.3); }
            .i-linkedin:hover { border-color: #0077b5; color: #0077b5; box-shadow: 0 0 12px rgba(0,119,181,0.3); }
        }
    }

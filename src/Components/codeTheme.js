...
const CodeTheme = () => {
    ...
    useEffect(() => {
        const codeLines = [
            ...
            '    this.dayOfBirthTimestamp = 1065187200;',
            ...
            '  education() {',
            '    return [',
            '      { "2021-2025": "VIT - B.Tech, Computer Science with Specializtion in Artifical Intelligence and Machine Learning" },',
            '',
            '    ];',
            '  }',
            '  skills() {',
            '    return [',
            '       "Google Cloud","AIML",""HTML/CSS/JS", "React", "Node.js", "R", "Next.js", "Python",',
  ...
  return (
    <div>
       ...
       {/* <p className="code-block typewriter">
        <div><br/>
        <span className="function">class</span> <span className="class-name">Arnav Bhargava</span> &#123;<br />
        <br/>
        &nbsp;&nbsp;<span className="function">constructor</span>() &#123;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;<span className="keyword">this</span>.<span className="property">name</span> = <span className="string">'Arnav Bhargava'</span><br />
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<span className="keyword">this</span>.<span className="property">email</span> = <span className="string">'Arnav.bansal945@gmail.com'</span><br />
        &nbsp;&nbsp;&#125;<br />
        </div>
        <div><br/>
